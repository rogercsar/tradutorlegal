...
/**
 * Analisa o texto do contrato com base no tipo.
 * @param {string} pdfText Texto extraído do PDF.
 * @param {string} contractType Tipo de contrato (locacao, servicos, etc).
 * @returns {object} Objeto com extractedData e tokensToSave.
 */
const analyzeText = (pdfText, contractType) => {
    const tokensToSave = [];
